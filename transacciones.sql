...
INSERT INTO detalle_compra(id, producto_id, compra_id, cantidad)
VALUES(44, 
	(SELECT id FROM producto WHERE descripcion = 'producto1'),
	34, 
	3
);
...
INSERT INTO detalle_compra(id, producto_id, compra_id, cantidad)
VALUES(45, 
	(SELECT id FROM producto WHERE descripcion = 'producto2'),
	34, 
	3
);
...
INSERT INTO detalle_compra(id, producto_id, compra_id, cantidad)
VALUES(46, 
	(SELECT id FROM producto WHERE descripcion = 'producto8'),
	34, 
	3
);
